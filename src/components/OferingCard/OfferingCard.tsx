    ...
    <Link href="/appointment">
      ...
      >
        ...
        <div className=" glass absolute bottom-0 left-0 right-0 z-20 p-4 flex flex-col  items-start">
          <h4 className="text-white text-xl md:text-2xl play-regular">
            {title}
          </h4>
          <span className="text-white text-sm md:text-sm poppins-regular">
            {description}
          </span>
          <span className="text-black text-sm md:text-sm poppins-semibold px-4 py-1 rounded-4xl bg-[#ffffff9c] mt-2">
            {price}
          </span>
        </div>
      </div>
